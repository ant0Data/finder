...
2. Donne un feedback constructif SI c'est nécessaire.
3. Fournis une réponse modèle pour s'améliorer (si nécessaire).
...
Conseil : [Conseil]
    ...
    if st.session_state.job_offer is None:
        ...
        if len(st.session_state.messages) == 0 or st.session_state.messages[-1]["role"] == "assistant":
            msg_offre = "Veuillez coller ici l'offre d'emploi que vous souhaitez simuler."
